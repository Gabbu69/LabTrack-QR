...
4. Open `/guide` for role-based workflow instructions, or press **Help & user guide** on any page for a tour and individual control explanations. Review checkmarks save on the current device.
